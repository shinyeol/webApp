...
<body>
	...
	<%@ include file="../main/menu.jsp" %>
		...
		<div id="content">
			...
			<form name="form1" method="post" action="${path}/product_servlet/insert.do" enctype="multipart/form-data">
						    ...
						    <colgroup>
				       		...
				       		<tbody>
								...
								<tr>
									<td>원산지(필수)</td>
									<td>
										<input name="p_country_of_origin" id="p_country_of_origin">
									</td>
								</tr>
								<tr>
									<td>상품명(필수)</td>
						...
						<table class="table_detail" style="width: 480px; margin: 0px;">
							...
							<tbody>
								...
								<tr>
									<td>포인트(필수)</td>
									<td>
										<input name="p_point" id="p_point">
									</td>
								</tr>																		
								<tr>
									<td>생산년도</td>
									<td>
										<input name="p_product_date" id="p_product_date" placeholder="YY년 MM월">
									</td>
								</tr>
								<tr>
									<td>생산자,수입자</td>
								...
								<tr>
									...
									<td>
										<div>
											<input type="file" name="p_img_main" id="p_img_main">
										</div>
									</td>
								</tr>
								<tr>
						...
						<table style="width: 100%;">
							<tr>
								<td style="text-align: center;">
									<div>
										<input class="btn-Type5" type="button" value="목록" onclick="location.href='${path}/product_servlet/productManage.do'">
										<input class="btn-Type5" type="button" value="등록" id="btnInsert"> 
									</div>
								</td>
							</tr>
						</table>
