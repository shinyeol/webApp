...
* > body{
	background: url(${path}/images/beans1.jpg) 100% 5px no-repeat;
	padding-right:205px
}
...
<br><br><br><br>
	<p><b>404 - Not Found </b> <ins> That’s an error.</ins>
  ...
  <button class="btn-Type4" onclick="goBack()">뒤로가기</button>
  <button class="btn-Type4" style="visibility: hidden;" >새로고침</button>
  <button class="btn-Type4" onclick="goHome()">홈페이지</button>
