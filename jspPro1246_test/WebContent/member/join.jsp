   ...
   <div id="page">
	...
	<%@ include file="../main/menu.jsp" %>
      ...
      <tr>
         <td>
            <div class="input-td">
            <input class="input-join" type="text" name="id" id="id" onchange="checkId()" onkeydown="inputIdChk()" placeholder="아이디 (대문자/특수기호/숫자 포함 8자 이상 16자 이내)">
      ...
      <tr>
         ...
         <td>
            <div class="input-td">
            <input class="input-join" type="text" name="addrDetail" id="addrDetail" placeholder="상세주소 (ex 천호대로 1095 현대코아 3층 )">
            </div><br>
         </td>
      </tr>         
      <tr>
