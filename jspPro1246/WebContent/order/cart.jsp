		...
		location.href = "${path}/cart_servlet/delete.do?c_idx=${dto.c_idx}";
				...
				<td>
					...
					<span class="txt_type70">
						<fmt:formatNumber value="${dto.money-(dto.money*0.05)}" pattern="###,###,###원"></fmt:formatNumber>
						<input type="hidden" name="show_sale_price" id="show_sale_price" value="${dto.money-(dto.money/0.05)}">
					</span>
				</td>
				<td>
				...
				<td>
					<span class="txt_type80"><span id="showTotSaleCost_1">
						<fmt:formatNumber value="${dto.money-(dto.money*0.05)}" pattern="###,###,###"></fmt:formatNumber>
					</span>원</span>
				</td>
				<td>
